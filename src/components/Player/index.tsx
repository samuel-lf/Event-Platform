        ...
        <div className='flex items-start gap-16'>
          <div className='flex-1'>
            ...
            <p className='mt-4 text-gray-200 leading-relaxed'>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Expedita soluta veritatis, nostrum ex animi dolorum maiores, dolor asperiores suscipit eaque id consequatur alias illo! Perferendis blanditiis sequi delectus facilis eos?
            </p>

            <div className='flex items-center gap-4 mt-6'>
              <img 
                className='h-16 w-16 rounded-full border-2 border-blue-500'
                src="https://github.com/samuel-lf.png" 
                alt="" 
              />
              <div className='leading-relaxed'>
                <strong className='font-bold text-2xl block'>Samuel Leonel</strong>
